  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#F8FAFC] pt-10 md:pt-10">
          ...
          <div className="container-custom py-12 sm:py-16">
            ...
            <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-12 lg:gap-12">
              <div className="lg:col-span-7">
                <p className="flex items-center gap-3 text-[11px] font-semibold uppercase tracking-[0.22em] text-primary-600">
                  <span className="block h-px w-8 bg-[#e0ae00]" aria-hidden />
                  Insights
                </p>
                <h1 className="mt-4 text-4xl font-nexa-heavy tracking-tight text-[#0B1220] sm:text-5xl md:text-[3.25rem] leading-[1.08]">
                  Perspectives on growth, technology, and execution
                </h1>
              </div>
              <div className="lg:col-span-5 flex flex-col justify-end gap-4 text-slate-600 leading-relaxed">
                <p className="text-lg">
                  Analysis and practical guidance on digital growth, cloud modernization, AI strategy, and business transformation.
                </p>
                <p className="text-sm text-slate-500">
                  Written for leaders and practitioners who need clear recommendations — not hype. Expect frameworks you can apply, lessons from delivery, and honest trade-offs when technology choices matter.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="sticky top-0 z-40 border-b border-slate-200/80 bg-white shadow-[0_1px_0_rgba(15,23,42,0.02)]">
          <div className="container-custom py-3">
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
              {/* Category chips */}
              <div className="flex gap-2 overflow-x-auto pb-1 lg:pb-0 lg:flex-wrap [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              ...
              {/* Search */}
              <form onSubmit={handleSearch} className="w-full lg:w-72 shrink-0">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-full border border-slate-300/90 bg-white py-2 pl-9 pr-4 text-sm text-slate-800 focus:border-primary-400 focus:outline-none focus:ring-2 focus:ring-primary-100"
                  />
                </div>
              </form>
            </div>
        ...
        {/* Newsletter — after the content so readers reach articles first */}
        <section className="border-t border-slate-200/80 bg-[#0B1220]">
